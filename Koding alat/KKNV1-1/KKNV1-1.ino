...
Time tt;
int jam, menit, detik;
int set_jam1 = 5;     //Set alarm jam Pagi
int set_menit1 = 00;   //Set alarm menit Pagi
int set_jam2 = 7;     //Set alarm jam Siang
int set_menit2 = 00;   //Set alarm menit Siang
int set_jam3 = 13;     //Set alarm jam Malam
int set_menit3 = 10;   //Set alarm menit Malam
...
void setup() {
  ...
  /*
       rtc.setDOW(3);     // Set Day-of-Week to DAYS(0=senin)
       rtc.setTime(22, 17, 0);     // Set the time exp: 12:00:00 (24hr format)
       rtc.setDate(26, 10, 2022);   // Set the date to Month, date, Year
  */
  //LCD Setup
